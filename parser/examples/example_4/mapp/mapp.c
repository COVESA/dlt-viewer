...
void main()
{
    ...
    DLT_LOG_ID0(myContext1,DLT_LOG_INFO,DLT_ID_MAPP_MCT1_1);
    DLT_LOG_ID1(myContext2,DLT_LOG_ERROR,DLT_ID_MAPP_MCT2_1, DLT_STRING("Hello DLT message"));
    DLT_LOG_ID2(myContext3,DLT_LOG_VERBOSE,DLT_ID_MAPP_MCT3_1, DLT_CSTRING("Hello value"), DLT_INT(-100));
    DLT_LOG_ID3(myContext1,DLT_LOG_FATAL,DLT_ID_MAPP_MCT1_1, DLT_CSTRING("Hello value2"), DLT_INT(-100), DLT_UINT(200));

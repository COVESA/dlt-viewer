...
void main()
{
    ...
    DLT_LOG_ID0(mycContext1,DLT_LOG_INFO,DLT_ID_CAPP_CCT1_944ef165);
    DLT_LOG_ID1(mycContext2,DLT_LOG_ERROR,DLT_ID_CAPP_CCT2_4451f8f2,DLT_STRING("Hello DLT message"));
    DLT_LOG_ID2(mycContext3,DLT_LOG_VERBOSE,DLT_ID_CAPP_CCT3_545fc245,DLT_CSTRING("Hello value"),DLT_INT(-100));
    DLT_LOG_ID3(mycContext1,DLT_LOG_FATAL,DLT_ID_CAPP_CCT1_387ba9d6,DLT_CSTRING("Hello value2"),DLT_INT(-100),DLT_UINT(200));
